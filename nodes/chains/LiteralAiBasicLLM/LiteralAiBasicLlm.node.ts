		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.literalai.literalai/',
					},
				],
			},
		},
						...
						values: [
							{
								...
								default: HumanMessagePromptTemplate.lc_name(),
							},
							{
